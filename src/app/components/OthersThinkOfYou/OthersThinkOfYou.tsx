  ...
  return (
    <section className="mt-10 rounded-3xl bg-blue-50 p-10">
      ...
      <div className="mt-8 flex justify-center relative">
        ...
        <div className="flex justify-between w-[70rem] z-[10]">
          <div className="flex flex-col justify-center">
            <div className="flex justify-center">
              <div className="p-2  w-10 h-10 flex justify-center items-center text-white bg-orange-400 rounded-full justify-self-center">
                1
              </div>
            </div>
...
export default OthersThinkOfYou;
