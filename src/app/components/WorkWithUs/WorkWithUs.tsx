          ...
          <div className="rounded-2xl bg-white  pt-8 max-w-[30rem] shadow-lg">
            ...
            <div className="flex flex-col gap-2 pt-8  p-4 rounded-2xl  mt-8 bg-orange-50">
              ...
              <p className="font-normal">
                ...
                temporibus dignissimos, laboriosam corporis deleniti quod quidem
                explicabo? Repellendus officiis odit corrupti ducimus soluta
                dolor accusamus repellat, nostrum suscipit, distinctio ipsam!
              </p>
            </div>
          </div>
        </div>
